// Generated from C:/Users/Jorey/Documents/School/APP/icss2022-sep/startcode/src/main/antlr4/nl/han/ica/icss/parser/ICSS.g4 by ANTLR 4.13.2
...
public class ICSSParser extends Parser {
	...
	public static final int
		...
		RULE_booleanLiteral = 4, RULE_styleTag = 5, RULE_variableName = 6, RULE_variableAssignment = 7, 
		RULE_selector = 8, RULE_tagSelector = 9, RULE_classSelector = 10, RULE_idSelector = 11, 
		RULE_expression = 12, RULE_booleanExpression = 13, RULE_comparisonExpression = 14, 
		RULE_ifStatement = 15, RULE_elseStatement = 16;
	private static String[] makeRuleNames() {
		return new String[] {
			"stylesheet", "stylerule", "styleDeclaration", "literal", "booleanLiteral", 
			"styleTag", "variableName", "variableAssignment", "selector", "tagSelector", 
			"classSelector", "idSelector", "expression", "booleanExpression", "comparisonExpression", 
	...
	public static class BooleanExpressionContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitBooleanExpression(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ComparisonExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).enterComparisonExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ICSSListener ) ((ICSSListener)listener).exitComparisonExpression(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ICSSVisitor ) return ((ICSSVisitor<? extends T>)visitor).visitComparisonExpression(this);
			else return visitor.visitChildren(this);
		}
	}
