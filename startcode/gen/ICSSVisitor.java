...
public interface ICSSVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ICSSParser#booleanExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBooleanExpression(ICSSParser.BooleanExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link ICSSParser#comparisonExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComparisonExpression(ICSSParser.ComparisonExpressionContext ctx);
	/**
